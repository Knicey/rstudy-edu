...
Dashboard -\> Modeling (focusing on goals and milestones progression)
...
I created some preliminary simple linear regression models within an interactive dashboard to explore the relationship between academic performance and various socioeconomic factors. I used the [@shiny] package to create the dashboard and the [@ggplot2] package to create visualizations for the data. I used the [@rsconnect] package to deploy the dashboard onto shinyapps.com where it can be publicly accessible.
