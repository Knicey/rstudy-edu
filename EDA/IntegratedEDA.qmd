...
anova(ugm3ALL_model, ugm3NEW_model.sv)
...
anova(ugm3NEW_model.f, ugm3NEW_model.f1)
```
...
This model fails to converge, so we will not include the random effect for share_virtual. This could be due to not enough variation in the share_virtual variable to estimate a random effect.
