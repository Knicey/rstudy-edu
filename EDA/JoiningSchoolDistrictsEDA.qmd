...
csdh_data <- lapply(csdh_files, read_csv_as_character)
...
trim_acs_social <- trim_acs_dataset(acs_social) |>
  ...
  select(stateabb, acs_region, married_household, married_household_children, male_married, female_married, male_never_married, female_never_married, male_divorced, female_divorced, birth_last_year, birth_last_year_unmarried, over_25_highschool_degree, over_25_associates_degree, over_25_bachelors_degree, over_25_graduate_degree, native_born, only_english, non_english, with_computer, with_internet)
...
trim_acs_demo <- trim_acs_dataset(acs_demo) |>
  ...
  select(stateabb, acs_region, population, sex_ratio, white_percent, black_percent, asian_percent)
