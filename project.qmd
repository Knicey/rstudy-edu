...
#demo(test_admindist_ys_all_math_nc, ask = FALSE, echo = FALSE)
#plot(st_geometry(nc))

#plot(test_admindist_ys_all_math_nc)
...
plot_usmap(data = HEDESKTOP_state, 
           values = "avg"
           )
  

#max(comp_internet_renamed$fips_district)
