...
## Mapping Data Prepping/Cleaning
...
```{r}
#| label: mapping-internet-use-maps-package
...
internet_map <- fipsCoded |>
  left_join(county_map, by = join_by(subregion == subregion))
...
plot_usmap(data = comp_mapping, values = "porportion", regions = "state") +
  scale_fill_continuous(low = "white", high = "red", name = "Porportion of those who report using Internet") + 
  labs(title = "District Map")
...
#Investigate the large number of not specified county codes, possibbly information not provided. See if people completed online/not specified FIPs have other geogrpahic data.
#Start bivariate 
...
Mapping districts to counties (NCES dataset?)

<https://nces.ed.gov/ccd/districtsearch/district_detail.asp?Search=1&details=1&InstName=Chapel+Hill-Carrboro+City+Schools&DistrictType=1&DistrictType=2&DistrictType=3&DistrictType=4&DistrictType=5&DistrictType=6&DistrictType=7&DistrictType=8&DistrictType=9&NumOfStudentsRange=more&NumOfSchoolsRange=more&ID2=3700720>
