...
income_district <- readr::read_csv("data/ACS Data/ACSST1Y2021.S1902-2024-04-10T232130.csv")
...
ssi_percent_district <- income_district_percentages |>
  mutate(
    ...
    household_income_all_households_with_social_security_income = sapply(gsub("(?<=\\d)%", "",household_income_all_households_with_social_security_income, perl = T), as.numeric)
  )
...
-   Project Report (Hopefully to review on 4/26)
